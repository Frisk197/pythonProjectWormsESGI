...
def loadGame(number_teams, number_vikings):
    ...
    while running_game:
        ...
        if mousePressed:
            ...
            #print(abs(created_teams[teamPlaying].vikings[selectedWorm].position.x - mouse_position[0]), abs(created_teams[teamPlaying].vikings[selectedWorm].position.y - mouse_position[1]))
